...
\title{Cotards's Syndrom \\Bila.}
\shorttitle{Bachelor Arbeit}
\author{Till J. Ernst}
\affiliation{ETH Psycholgy}
...
\keywords{Bindungstheorie, Bindung, Eltern-Kind-Beziehungen, Stress, Wohlbefinden, Kommunikationsmedien, Smartphone}
...
% Das Gehirn muss den verursachenden Reiz schatzen: Was ist die wahrscheinlichste Ursache der sensorischen Information (best guess). Das gilt auch fur sensorische Reize aus dem Korperinnern (Interozeption) Anteriorer insularer Kortex als Schnittstelle zu interozeptiven Informationen  Als Resultat ergibt sich ein kérperliches Ownership-Empfinden (im Cotard Syndrom nicht mehr vorhanden)
